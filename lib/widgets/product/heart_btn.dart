...
class _HeartButtonWidgetState extends State<HeartButtonWidget> {
  bool isLiked = false; // prati da li je srce “lajkovano”
    ...
    return Container(
      ...
      child: IconButton(
        ...
        icon: Icon(
          ...
          size: widget.size,
          color: isLiked
              ? Colors.red // crveno kada je lajkovano
              : (isDark ? AppColors.lightVanilla : AppColors.chocolateDark), // tema-dependent kada nije lajkovano
        ),
      ),
    );
  }
